...
#include "src/pbsdatamodel.h"
#include "src/FilterLineEdit.h"
#include "src/pbsappsettings.h"
...
PBSTableView::PBSTableView(QString sSettings, QWidget *parent) :
    ...
    pLayout(this),
    actFooter(QIcon(":/Resource/Images/footer.png"), PBSTR("Убрать заголовки"), this),
    actFilter(QIcon(":/Resource/Images/filter.png"), tr( "Включить фильтр"), this),
    ...
    actStretchColumn(QIcon(":/Resource/Images/stretch.png"), PBSTR("По ширине колонки"), this),
    actStretchColumnAll(QIcon(":/Resource/Images/stretchall.png"), PBSTR("По ширине колонки (Все)"), this),
    actStretch(QIcon(":/Resource/Images/sigdir.png"), PBSTR("По ширине окна"), this),
    ...
    actSendToPrinter(QIcon(":/Resource/Images/printer.png"), PBSTR("Печать..."), this),
    actSavePDF(QIcon(":/Resource/Images/pdf.png"), PBSTR("PDF Создать"), this),
...
void PBSTableView::createPopupMenu()
{
    ...
    popupMenu.addSeparator();
    QMenu *saveAsMenu = popupMenu.addMenu(QIcon(":/Resource/Images/save.png"), PBSTR("Преобразовать в  ..."));
