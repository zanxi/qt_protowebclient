    ...
    , ui(new Ui::MainWindow)
{
    ...
    //ui->label_title->setStyleSheet("QLabel {color: white; background: WhiteSmoke;}");
    ...
    connect(this, &Main_DigitalFarm::signal, w_m, &Widget_menu::slot);
    connect(w_m, &Widget_menu::signalMenu, this, &Main_DigitalFarm::slotMenu);
...
//void Main_DigitalFarm::Exit(){}

void Main_DigitalFarm::InitDBautorization()
{    
...
void Main_DigitalFarm::create()
{
    ...
    //logger::WriteMsg("Main_DigitalFarm before - SaveAutorizartion() - closed db : ~DataBase");
...
void Main_DigitalFarm::GetLastId()
{
...
void Main_DigitalFarm::GetUserId()
{
...
void Main_DigitalFarm::SaveAutorizartion()
{
    GetUserId();
...
void Main_DigitalFarm::on_action_triggered()
{
    return;
