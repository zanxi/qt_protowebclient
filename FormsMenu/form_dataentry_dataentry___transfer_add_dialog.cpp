#include "form_dataentry_dataentry___transfer_add_dialog.h"
#include "ui_form_dataentry_dataentry___transfer_add_dialog.h"

#include "dataanimals.h"

form_dataentry_dataentry___transfer_add_Dialog::form_dataentry_dataentry___transfer_add_Dialog(QWidget *parent) :
    QDialog(parent),
...
form_dataentry_dataentry___transfer_add_Dialog::~form_dataentry_dataentry___transfer_add_Dialog()
{
    delete ui;
}

void form_dataentry_dataentry___transfer_add_Dialog::SetData()
{

}


void form_dataentry_dataentry___transfer_add_Dialog::on_pushButton_save_clicked()
{
