#ifndef FORM_DATAENTRY_ROBOT_DIALOG_H
#define FORM_DATAENTRY_ROBOT_DIALOG_H
...
namespace Ui {
class form_dataentry_robot_Dialog;
}

class form_dataentry_robot_Dialog : public QDialog
{
    Q_OBJECT

public:
    explicit form_dataentry_robot_Dialog(QWidget *parent = nullptr);
    ~form_dataentry_robot_Dialog();
...
private:
    Ui::form_dataentry_robot_Dialog *ui;
};

#endif // FORM_DATAENTRY_ROBOT_DIALOG_H
